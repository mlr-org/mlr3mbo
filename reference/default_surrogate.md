...
[Surrogate](https://mlr3mbo.mlr-org.com/reference/Surrogate.md) based on
properties of the
...
- n_learner:
  ...
  construction of the
  [Surrogate](https://mlr3mbo.mlr-org.com/reference/Surrogate.md). If
  not specified will be based on the number of objectives as stated by
  the instance.
