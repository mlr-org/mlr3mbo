...
Based on these, Bayesian optimization loops can be written, see, e.g., `bayesopt_soo` for sequential single objective BO.
...
Minimize `y = x^2` via sequential single objective BO using a GP as surrogate and EI optimized via random search as aquisition function:
