...
#> WARN  [13:54:01.729] [bbotk] Could not update the surrogate a final time after the optimization process has terminated.
#>            x  x_domain        y1       y2
#>        <num>    <list>     <num>    <num>
#> 1:  3.694496 <list[1]> 13.649302 2.871317
#> 2: -1.001383 <list[1]>  1.002767 9.008297
# }
```
