...
- [`InputTrafo$format()`](https://mlr3mbo.mlr-org.com/dev/reference/InputTrafo.html#method-format)
- [`InputTrafo$print()`](https://mlr3mbo.mlr-org.com/dev/reference/InputTrafo.html#method-print)
