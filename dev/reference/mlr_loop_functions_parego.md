...
#> WARN  [08:09:59.787] [bbotk] Could not update the surrogate a final time after the optimization process has terminated.
#>             x  x_domain        y1        y2
#>         <num>    <list>     <num>     <num>
#> 1: -0.9253407 <list[1]> 0.8562553 8.5576179
#> 2:  1.2115900 <list[1]> 1.4679504 0.6215903
# }
```
