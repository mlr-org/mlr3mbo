...
#' The new objective is a weighted version of the prediction problem, where the goal
#' is to predict whether an instance is smaller than the `gamma` quantile of the target 
#' distribution.
#' 
#' @export
LearnerLFBO = R6Class("LearnerLFBO",
