...
* fix: `bayesopt_mpcl` no longer aborts when a batch mixes model based and randomly sampled proposals, for example with random interleaving or an error fallback.
